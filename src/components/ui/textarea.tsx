    ...
    return (
      <textarea
        className={cn(
          ...
          "border-zinc-300 focus-visible:ring-zinc-400 dark:border-zinc-600 dark:placeholder:text-zinc-400 dark:focus-visible:ring-zinc-500 dark:bg-zinc-700 dark:text-white", // default
          error &&
