...
export default function Footer() {
  ...
  return (
    <footer className="w-full flex flex-col bg-zinc-800 dark:bg-zinc-900">
      <div className="p-10 bg-zinc-800 dark:bg-zinc-900 text-white grid grid-cols-4 gap-4 font-primary container mx-auto">
        {/* Logo */}
